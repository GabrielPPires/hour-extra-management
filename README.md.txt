...
O projeto surgiu como uma evolução direta do projeto anterior hora-extra-automation, substituindo processos baseados exclusivamente em Excel por uma arquitetura integrada com Microsoft Forms, Microsoft Lists, SharePoint, Power Query e VBA.
